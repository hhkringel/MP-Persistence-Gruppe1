...
class TestCaseNo2ErrorInProductAndCustomerOrder {
	...
	@Test
	public void shouldGiveErrorOnBothProductAndCustomerOnOrder() {
		
		// Arrange
		Address testAddress = new Address("Havevej", 4000, "Vejby", "Rusland");
		PrivateCustomer testCustomer = customerController.createPrivateCustomer(1, 1, "givmigpenge@ofir.dk", testAddress);
		...
		// Assert
		assertNull(testSaleOrder.getCustomer(), "Should be null");
